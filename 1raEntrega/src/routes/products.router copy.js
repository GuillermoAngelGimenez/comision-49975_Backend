...
async function validacionesCamposProductos(body, res) {
  let {
    title,
    description,
    code,
...
router.post("/", async (req, res) => {
  ...
  // validacionesCamposProductos(req.body, res);
  ...
  pm.addProduct(newProduct, products);
...
router.put("/:id", async (req, res) => {
  ...
  // validacionesCamposProductos(req.body);
